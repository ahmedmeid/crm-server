...
public class DepartmentTestSamples {
    ...
    public static Department getDepartmentSample1() {
        return new Department().id(1L).departmentName("departmentName1").description("description1");
    }

    public static Department getDepartmentSample2() {
        return new Department().id(2L).departmentName("departmentName2").description("description2");
    }
