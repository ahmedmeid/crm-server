...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ahmedmeid.crm.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ahmedmeid.crm.security.DomainUserDetailsService", "createSpringSecurityUser");
